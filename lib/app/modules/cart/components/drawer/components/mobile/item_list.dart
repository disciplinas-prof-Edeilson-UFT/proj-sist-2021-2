...
import 'package:pscomidas/app/modules/cart/components/drawer/components/mobile/item_builder.dart';

class MobileItenList extends StatelessWidget {
  final double heightFactor;
  final int itenlengh;
  final double widthFactor;
  const MobileItenList({
    Key? key,
