...
class FormPaymentPage extends StatefulWidget {
  final String title;
  const FormPaymentPage({Key? key, this.title = 'FormPaymentPage'}) : super(key: key);
  @override
            ...
            children: [
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      'Formas de pagamento',
                      style: TextStyle(fontSize: screenSize.width * 0.027, fontWeight: FontWeight.bold,),
                    ),
                  ],
                ),
              ),
              ...
              Container(
                ...
                child: TextButton(
                  ...
                  onPressed: (){
                    Modular.to.navigate('/addPayments');
                  }, 
